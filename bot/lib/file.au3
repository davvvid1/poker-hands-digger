...
Func loadConfig()
   ...
   $config[7] = IniRead("config.ini", "general", "tablesHeight", 0)
   $config[8] = IniRead("config.ini", "general", "tableFullHandsOffsetX", 0)
   $config[9] = IniRead("config.ini", "general", "tableFullHandsOffsetY", 0)
   $config[10] = IniRead("config.ini", "general", "tableFullHandsCol", 0)
   $config[11] = IniRead("config.ini", "general", "tableRecommendsOffsetX", 0)
   $config[12] = IniRead("config.ini", "general", "tableRecommendsOffsetY", 0)
   $config[13] = IniRead("config.ini", "general", "tableRecommendsCol", 0)
   $config[14] = IniRead("config.ini", "general", "handsScanOffsetX", 0)
   $config[15] = IniRead("config.ini", "general", "handsScanOffsetY", 0)
   $config[16] = IniRead("config.ini", "general", "handsScanCol", 0)
   $config[17] = IniRead("config.ini", "general", "handsHeight", 0)
   $config[18] = IniRead("config.ini", "general", "handOptionsOffsetX", 0)
   $config[19] = IniRead("config.ini", "general", "handOptionsOffsetY", 0)
   $config[20] = IniRead("config.ini", "general", "handOptionsCol", 0)
   $config[21] = IniRead("config.ini", "general", "handShareOffsetX", 0)
   $config[22] = IniRead("config.ini", "general", "handShareOffsetY", 0)
   $config[23] = IniRead("config.ini", "general", "handShareCol", 0)
   $config[24] = IniRead("config.ini", "general", "handCopyOffsetX", 0)
   $config[25] = IniRead("config.ini", "general", "handCopyOffsetY", 0)
   $config[26] = IniRead("config.ini", "general", "handCopyCol", 0)
   $config[27] = IniRead("config.ini", "general", "handBackOffsetX", 0)
   $config[28] = IniRead("config.ini", "general", "handBackOffsetY", 0)
...
Func isUniqueHand($json)
   ...
   For $i = 1 To $files[0] Step 1
	  If StringInStr ($files[$i], ".txt") Then
		 ...
		 If $isUnique And StringInStr(FileReadLine(@WorkingDir & "/" & $files[$i], 1), $json) Then
